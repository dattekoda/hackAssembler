...
pub extern fn vfprintf(noalias __s: [*c]FILE, noalias __format: [*c]const u8, __arg: __gnuc_va_list) c_int;
pub extern fn vprintf(noalias __format: [*c]const u8, __arg: __gnuc_va_list) c_int;
pub extern fn vsprintf(noalias __s: [*c]u8, noalias __format: [*c]const u8, __arg: __gnuc_va_list) c_int;
pub extern fn snprintf(noalias __s: [*c]u8, __maxlen: usize, noalias __format: [*c]const u8, ...) c_int;
pub extern fn vsnprintf(noalias __s: [*c]u8, __maxlen: usize, noalias __format: [*c]const u8, __arg: __gnuc_va_list) c_int;
...
pub extern fn vfscanf(noalias __s: [*c]FILE, noalias __format: [*c]const u8, __arg: __gnuc_va_list) c_int;
pub extern fn vscanf(noalias __format: [*c]const u8, __arg: __gnuc_va_list) c_int;
pub extern fn vsscanf(noalias __s: [*c]const u8, noalias __format: [*c]const u8, __arg: __gnuc_va_list) c_int;
...
pub const t_lst = struct_s_lst;
pub const struct_s_lst = extern struct {
    data: ?*anyopaque = null,
    next: [*c]t_lst = null,
    pub const delLst = __root.delLst;
    pub const destructLst = __root.destructLst;
    pub const assembleHack = __root.assembleHack;
    pub const codeHack = __root.codeHack;
};
pub extern fn createLst(data: ?*anyopaque, next: [*c]t_lst) [*c]t_lst;
pub extern fn delLst(lst: [*c]t_lst, del: ?*const fn (?*anyopaque) callconv(.c) void) void;
pub extern fn destructLst(head: [*c]t_lst, del: ?*const fn (?*anyopaque) callconv(.c) void) void;
pub extern fn ft_atoi(s: [*c]const u8) c_int;
pub extern fn ft_strlen(s: [*c]const u8) usize;
pub extern fn ft_strncmp(s1: [*c]const u8, s2: [*c]const u8, n: usize) c_int;
pub extern fn ft_memmove(dst: ?*anyopaque, src: ?*const anyopaque, n: usize) c_int;
pub extern fn ft_memset(s: ?*anyopaque, c: c_int, n: usize) ?*anyopaque;
pub extern fn ft_isspace(c: c_int) c_int;
pub extern fn ft_strchr(s: [*c]const u8, c: c_int) [*c]u8;
pub extern fn ft_get_next_line(line: [*c][*c]u8, fd: c_int) c_int; // src/main.c:416:6: warning: TODO unable to translate variadic function, demoted to extern
pub extern fn @"error"(fmt: [*c]const u8, ...) void;
pub fn isInvalidArg(arg_argc: c_int, arg_argv: [*c][*c]u8) callconv(.c) c_int {
    var argc = arg_argc;
    _ = &argc;
    var argv = arg_argv;
    _ = &argv;
    if (argc != @as(c_int, 2)) return 1;
    g_file_name_len = ft_strlen(argv[@as(c_int, 1)]);
    if ((g_file_name_len < @as(usize, 5)) or (ft_strncmp((argv[@as(c_int, 1)] + g_file_name_len) - @as(usize, @bitCast(@as(isize, @intCast(@as(c_int, 4))))), ".asm", 4) != 0)) return 1;
    return 0;
}
pub export fn readFileToLst(arg_lst: [*c][*c]t_lst) c_int {
    var lst = arg_lst;
    _ = &lst;
    var fd: c_int = open(g_file_name, O_RDONLY);
    _ = &fd;
    if (fd < @as(c_int, 0)) return blk: {
        @"error"("%s: %s", g_file_name, strerror(__errno_location().*));
        break :blk 1;
    };
    if (allocLst(lst, fd) != 0) return blk: {
        _ = close(fd);
        break :blk 1;
    };
    _ = close(fd);
...
pub export fn assembleHack(arg_lst: [*c]const t_lst) c_int {
    var lst = arg_lst;
    _ = &lst;
    var info_lst: [*c]t_lst = undefined;
    _ = &info_lst;
    if (parseHack(&info_lst, lst) != 0) return 1;
    if (codeHack(info_lst) != 0) return 1;
    destructLst(info_lst, free);
    return 0;
}
pub export var g_file_name_len: usize = 0;
pub export var g_file_name: [*c]u8 = null;
pub export fn main(arg_argc: c_int, arg_argv: [*c][*c]u8) c_int {
    var argc = arg_argc;
    _ = &argc;
    var argv = arg_argv;
    _ = &argv;
    var lst: [*c]t_lst = undefined;
    _ = &lst;
    if (isInvalidArg(argc, argv) != 0) return blk: {
        @"error"("%s prog.asm", argv[@as(c_int, 0)]);
        break :blk 1;
    };
    g_file_name = argv[@as(c_int, 1)];
    if (readFileToLst(&lst) != 0) return 1;
    if (assembleHack(lst) != 0) return 1;
    destructLst(lst, free);
    return 0;
}
pub const A_INSTRUCTION: c_int = 0;
pub const C_INSTRUCTION: c_int = 1;
pub const L_INSTRUCTION: c_int = 2;
pub const N_INSTRUCTION: c_int = 3;
pub const e_instructionType = c_uint;
pub const struct_s_info = extern struct {
    i: e_instructionType = @import("std").mem.zeroes(e_instructionType),
    labelSymbol: u16 = 0,
    dest: [*c]u8 = null,
    comp: [*c]u8 = null,
    jump: [*c]u8 = null,
    pub const setAinfo = __root.setAinfo;
    pub const setCinfo = __root.setCinfo;
    pub const isInvalidInfo = __root.isInvalidInfo;
};
pub const t_info = struct_s_info;
pub export fn constructInfos(arg_info_lst: [*c][*c]t_lst, arg_lst: [*c]const t_lst) c_int {
    var info_lst = arg_info_lst;
    _ = &info_lst;
    var lst = arg_lst;
    _ = &lst;
    var head: t_lst = undefined;
    _ = &head;
    var curr: [*c]t_lst = undefined;
    _ = &curr;
    var info: [*c]t_info = undefined;
    _ = &info;
    curr = &head;
    while ((curr != null) and (lst != null)) {
        if (isSkippableLine(@ptrCast(@alignCast(lst.*.data))) != 0) {
            lst = lst.*.next;
            continue;
        }
        if (constructInfo(&info, @ptrCast(@alignCast(lst.*.data))) != 0) return blk: {
            destructLst(head.next, free);
            break :blk 1;
        };
        curr.*.next = createLst(@ptrCast(@alignCast(info)), null);
        curr = curr.*.next;
        lst = lst.*.next;
    }
    if (!(curr != null)) return blk: {
        destructLst(head.next, free);
        break :blk 1;
    };
    info_lst.* = head.next;
...
pub export fn parseHack(arg_info_lst: [*c][*c]t_lst, arg_lst: [*c]const t_lst) c_int {
    var info_lst = arg_info_lst;
    _ = &info_lst;
    var lst = arg_lst;
    _ = &lst;
    if (constructInfos(info_lst, lst) != 0) return 1;
    return 0;
}
pub fn isSkippableLine(arg_line: [*c]const u8) callconv(.c) c_int {
    var line = arg_line;
    _ = &line;
    while (ft_isspace(line.*) != 0) {
        line += 1;
    }
    if (@as(c_int, line.*) == @as(c_int, '\x00')) return 1;
    if (ft_strncmp(line, "//", 2) == @as(c_int, 0)) return 1;
    return 0;
}
pub fn constructInfo(arg_info: [*c][*c]t_info, arg_line: [*c]u8) callconv(.c) c_int {
    var info = arg_info;
    _ = &info;
    var line = arg_line;
    _ = &line;
    var _info: t_info = undefined;
    _ = &_info;
    _ = ft_memset(@ptrCast(@alignCast(&_info)), 0, @sizeOf(t_info));
    while (ft_isspace(line.*) != 0) {
        line += 1;
    }
    _info.i = getInstruction(line);
    if (_info.i == @as(e_instructionType, A_INSTRUCTION)) {
        setAinfo(&_info, line);
    } else if (_info.i == @as(e_instructionType, C_INSTRUCTION)) {
        setCinfo(&_info, line);
    } else if (_info.i == @as(e_instructionType, L_INSTRUCTION)) {
        _ = printf("L\n");
    }
    if (isInvalidInfo(&_info) != 0) return 1;
    info.* = @ptrCast(@alignCast(malloc(@sizeOf(t_info))));
    if (!(info.* != null)) return blk: {
        @"error"("%s", strerror(__errno_location().*));
        break :blk 1;
    };
    _ = ft_memmove(@ptrCast(@alignCast(info.*)), @ptrCast(@alignCast(&_info)), @sizeOf(t_info));
    return 0;
}
pub fn getInstruction(arg_line: [*c]const u8) callconv(.c) e_instructionType {
    var line = arg_line;
    _ = &line;
    if (@as(c_int, line.*) == @as(c_int, '@')) return A_INSTRUCTION else if (ft_strchr(line, '(') != null) return L_INSTRUCTION;
    return C_INSTRUCTION;
}
pub fn setAinfo(arg__info: [*c]t_info, arg_line: [*c]const u8) callconv(.c) void {
    var _info = arg__info;
    _ = &_info;
    var line = arg_line;
    _ = &line;
    _info.*.labelSymbol = @bitCast(@as(c_short, @truncate(ft_atoi(line + @as(usize, @bitCast(@as(isize, @intCast(@as(c_int, 1)))))) & @as(c_int, 32767))));
}
pub fn setCinfo(arg__info: [*c]t_info, arg_line: [*c]u8) callconv(.c) void {
    var _info = arg__info;
    _ = &_info;
    var line = arg_line;
    _ = &line;
    var semi_column_p: [*c]u8 = ft_strchr(line, ';');
    _ = &semi_column_p;
    var equal_p: [*c]u8 = ft_strchr(line, '=');
    _ = &equal_p;
    if (semi_column_p != null) {
        semi_column_p.* = '\x00';
        _info.*.jump = semi_column_p + @as(usize, @bitCast(@as(isize, @intCast(@as(c_int, 1)))));
    }
    if (equal_p != null) {
        equal_p.* = '\x00';
        _info.*.dest = line;
        _info.*.comp = equal_p + @as(usize, @bitCast(@as(isize, @intCast(@as(c_int, 1)))));
    } else {
        line = blk: {
            const tmp = line;
            _info.*.comp = tmp;
...
pub fn isInvalidInfo(arg__info: [*c]const t_info) callconv(.c) c_int {
    var _info = arg__info;
    _ = &_info;
    if (_info.*.i == @as(e_instructionType, C_INSTRUCTION)) {
        if (!(@as(c_int, _info.*.comp.*) != 0)) return blk: {
            @"error"("set comp");
            break :blk 1;
        };
    }
...
pub fn creatHackFile() callconv(.c) c_int {
    var hack_file_name: [*c]u8 = undefined;
    _ = &hack_file_name;
    var fd: c_int = undefined;
    _ = &fd;
    hack_file_name = @ptrCast(@alignCast(malloc(g_file_name_len +% @as(usize, 2))));
    if (!(hack_file_name != null)) return blk: {
        @"error"("%s", strerror(__errno_location().*));
        break :blk 1;
    };
    _ = ft_memmove(@ptrCast(@alignCast(hack_file_name)), @ptrCast(@alignCast(g_file_name)), g_file_name_len -% @as(usize, 4));
    _ = ft_memmove(@ptrCast(@alignCast((hack_file_name + g_file_name_len) - @as(usize, @bitCast(@as(isize, @intCast(@as(c_int, 4))))))), @ptrCast(@alignCast(@constCast(".hack"))), 6);
    fd = open(hack_file_name, (O_CREAT | O_WRONLY) | O_TRUNC, @as(c_int, 509));
    if (fd < @as(c_int, 0)) {
        @"error"("%s: %s", hack_file_name, strerror(__errno_location().*));
    }
    free(@ptrCast(@alignCast(hack_file_name)));
    return fd;
}
pub fn writeHackLines(arg_fd: c_int, arg_info_lst: [*c]const t_lst) callconv(.c) void {
    var fd = arg_fd;
    _ = &fd;
    var info_lst = arg_info_lst;
    _ = &info_lst;
    ...
    buf[@as(c_int, 16)] = '\n';
    while (info_lst != null) {
        setHackLine(@ptrCast(@alignCast(&buf)), @ptrCast(@alignCast(info_lst.*.data)));
        _ = write(fd, @ptrCast(@alignCast(@as([*c]u8, @ptrCast(@alignCast(&buf))))), 17);
        info_lst = info_lst.*.next;
    }
}
pub export fn codeHack(arg_info_lst: [*c]const t_lst) c_int {
    var info_lst = arg_info_lst;
    _ = &info_lst;
    var fd: c_int = undefined;
    _ = &fd;
    fd = creatHackFile();
    if (fd < @as(c_int, 0)) return 1;
    writeHackLines(fd, info_lst);
    _ = close(fd);
    return 0;
}
pub export fn setHackLine(arg_buf: [*c]u8, arg_info: [*c]const t_info) void {
    var buf = arg_buf;
    _ = &buf;
    var info = arg_info;
    _ = &info;
    if (info.*.i == @as(e_instructionType, A_INSTRUCTION)) {
        setALine(buf, info);
    } else if (info.*.i == @as(e_instructionType, C_INSTRUCTION)) {
        setCLine(buf, info);
    } else if (info.*.i == @as(e_instructionType, L_INSTRUCTION)) {
        _ = ft_memset(@ptrCast(@alignCast(buf)), '1', @sizeOf(u8) *% @as(c_ulong, 16));
    }
}
pub fn setALine(arg_buf: [*c]u8, arg_info: [*c]const t_info) callconv(.c) void {
    var buf = arg_buf;
    _ = &buf;
    var info = arg_info;
    _ = &info;
    var offset: u16 = @bitCast(@as(c_short, @truncate(@as(c_int, 1) << @intCast(@as(c_int, 14)))));
    _ = &offset;
    var idx: u8 = 0;
    _ = &idx;
    buf[@as(c_int, 0)] = '0';
    while ((blk: {
        ...
        if ((@as(c_int, offset) & @as(c_int, info.*.labelSymbol)) != 0) {
            buf[idx] = '1';
        } else {
            buf[idx] = '0';
        }
        {
            const ref = &offset;
            ref.* = @bitCast(@as(c_short, @truncate(@as(c_int, ref.*) >> @intCast(@as(c_int, 1)))));
        }
    }
}
pub fn setCLine(arg_buf: [*c]u8, arg_info: [*c]const t_info) callconv(.c) void {
    var buf = arg_buf;
    _ = &buf;
    var info = arg_info;
    _ = &info;
    _ = ft_memset(@ptrCast(@alignCast(buf)), '1', @sizeOf(u8) *% @as(c_ulong, 3));
    _ = ft_memset(@ptrCast(@alignCast(buf + @as(usize, @bitCast(@as(isize, @intCast(@as(c_int, 3))))))), '0', @sizeOf(u8) *% @as(c_ulong, 13));
    setComp(buf + @as(usize, @bitCast(@as(isize, @intCast(@as(c_int, 3))))), info.*.comp);
    setDest(buf + @as(usize, @bitCast(@as(isize, @intCast(@as(c_int, 10))))), info.*.dest);
    setJump(buf + @as(usize, @bitCast(@as(isize, @intCast(@as(c_int, 13))))), info.*.jump);
}
pub fn setComp(arg_buf: [*c]u8, arg_comp: [*c]const u8) callconv(.c) void {
    var buf = arg_buf;
    _ = &buf;
    var comp = arg_comp;
    _ = &comp;
    const comp_len: usize = ft_strlen(comp);
    _ = &comp_len;
    var m_ptr: [*c]u8 = ft_strchr(comp, 'M');
    _ = &m_ptr;
    if (m_ptr != null) {
        m_ptr.* = 'A';
        buf[@as(c_int, 0)] = '1';
    }
    if (comp_len == @as(usize, 1)) {
        set1Comp(buf + @as(usize, @bitCast(@as(isize, @intCast(@as(c_int, 1))))), comp);
    } else if (comp_len == @as(usize, 2)) {
        set2Comp(buf + @as(usize, @bitCast(@as(isize, @intCast(@as(c_int, 1))))), comp);
    } else if (comp_len == @as(usize, 3)) {
        set3Comp(buf + @as(usize, @bitCast(@as(isize, @intCast(@as(c_int, 1))))), comp);
    }
}
pub fn setDest(arg_buf: [*c]u8, arg_dest: [*c]const u8) callconv(.c) void {
    var buf = arg_buf;
    _ = &buf;
    var dest = arg_dest;
    _ = &dest;
    if (!(dest != null)) return;
    if (ft_strchr(dest, 'M') != null) {
        buf[@as(c_int, 2)] = '1';
    }
    if (ft_strchr(dest, 'D') != null) {
        buf[@as(c_int, 1)] = '1';
    }
    if (ft_strchr(dest, 'A') != null) {
        buf[@as(c_int, 0)] = '1';
    }
}
pub fn setJump(arg_buf: [*c]u8, arg_jump: [*c]const u8) callconv(.c) void {
    var buf = arg_buf;
    _ = &buf;
    var jump = arg_jump;
    _ = &jump;
    if (!(jump != null) or (ft_strlen(jump) != @as(usize, 3))) return;
    _ = ft_memmove(@ptrCast(@alignCast(buf)), @ptrCast(@alignCast(getJumpBinary(jump))), 3);
}
pub fn set1Comp(arg_buf: [*c]u8, arg_comp: [*c]const u8) callconv(.c) void {
    var buf = arg_buf;
    _ = &buf;
    var comp = arg_comp;
    _ = &comp;
    if (@as(c_int, comp.*) == @as(c_int, '0')) {
        _ = ft_memmove(@ptrCast(@alignCast(buf)), @ptrCast(@alignCast(@constCast("10101"))), 5);
    } else if (@as(c_int, comp.*) == @as(c_int, '1')) {
        _ = ft_memset(@ptrCast(@alignCast(buf)), '1', 6);
    } else if (@as(c_int, comp.*) == @as(c_int, 'D')) {
        _ = ft_memset(@ptrCast(@alignCast(buf + @as(usize, @bitCast(@as(isize, @intCast(@as(c_int, 2))))))), '1', 2);
    } else if (@as(c_int, comp.*) == @as(c_int, 'A')) {
        _ = ft_memset(@ptrCast(@alignCast(buf)), '1', 2);
    }
}
pub fn set2Comp(arg_buf: [*c]u8, arg_comp: [*c]const u8) callconv(.c) void {
    var buf = arg_buf;
    _ = &buf;
    var comp = arg_comp;
    _ = &comp;
    if (@as(c_int, comp.*) == @as(c_int, '-')) {
        buf[@as(c_int, 4)] = '1';
    }
    if (@as(c_int, (comp + @as(usize, @bitCast(@as(isize, @intCast(@as(c_int, 1)))))).*) == @as(c_int, 'A')) {
        buf[@as(c_int, 5)] = '1';
        _ = ft_memset(@ptrCast(@alignCast(buf)), '1', 2);
    } else if (@as(c_int, (comp + @as(usize, @bitCast(@as(isize, @intCast(@as(c_int, 1)))))).*) == @as(c_int, 'D')) {
        buf[@as(c_int, 5)] = '1';
        _ = ft_memset(@ptrCast(@alignCast(buf + @as(usize, @bitCast(@as(isize, @intCast(@as(c_int, 2))))))), '1', 2);
    } else {
        _ = ft_memset(@ptrCast(@alignCast(buf)), '1', 3);
    }
}
pub fn set3Comp(arg_buf: [*c]u8, arg_comp: [*c]const u8) callconv(.c) void {
    var buf = arg_buf;
    _ = &buf;
    var comp = arg_comp;
    _ = &comp;
    _ = ft_memmove(@ptrCast(@alignCast(buf)), @ptrCast(@alignCast(get3CompBinary(comp))), 6);
}
pub fn get3CompBinary(arg_comp: [*c]const u8) callconv(.c) [*c]u8 {
    var comp = arg_comp;
    _ = &comp;
    const static_local_dic = struct {
        var dic: [10][9]u8 = [9][9]u8{
            "D+1011111",
            "A+1110111",
            "D-1001110",
            "A-1110010",
            ...
            "D&A000000",
            "D|A010101",
        } ++ [1][9]u8{@import("std").mem.zeroes([9]u8)} ** 1;
    };
    _ = &static_local_dic;
    {
        var i: c_int = 0;
        ...
        while (i < @as(c_int, 9)) : (i += 1) {
            if (ft_strncmp(comp, @ptrCast(@alignCast(&static_local_dic.dic[@bitCast(@as(isize, @intCast(i)))])), 3) == @as(c_int, 0)) {
                return @as([*c]u8, @ptrCast(@alignCast(@constCast(@as([*c]const u8, @ptrCast(@alignCast(&static_local_dic.dic[@bitCast(@as(isize, @intCast(i)))]))))))) + @as(usize, @bitCast(@as(isize, @intCast(@as(c_int, 3)))));
            }
        }
    }
    return @constCast("000000");
}
pub fn getJumpBinary(arg_jump: [*c]const u8) callconv(.c) [*c]u8 {
    var jump = arg_jump;
    _ = &jump;
    const static_local_dic = struct {
        var dic: [7][7]u8 = [7][7]u8{
            "JGT001",
            "JEQ010",
            "JGE011",
            "JLT100",
    ...
    while ((blk: {
        ...
        if (ft_strncmp(jump, @ptrCast(@alignCast(&static_local_dic.dic[@bitCast(@as(isize, @intCast(i)))])), 3) == @as(c_int, 0)) return @as([*c]u8, @ptrCast(@alignCast(@constCast(@as([*c]const u8, @ptrCast(@alignCast(&static_local_dic.dic[@bitCast(@as(isize, @intCast(i)))]))))))) + @as(usize, @bitCast(@as(isize, @intCast(@as(c_int, 3)))));
    }
    return @constCast("000");
}
pub export fn allocLst(arg_lst: [*c][*c]t_lst, arg_fd: c_int) c_int {
    var lst = arg_lst;
    _ = &lst;
    var fd = arg_fd;
    _ = &fd;
    var gnl_ret: c_int = undefined;
    _ = &gnl_ret;
    ...
    while (curr != null) {
        ...
        if (gnl_ret == -@as(c_int, 1)) return blk: {
            destructLst(head.next, free);
            @"error"("%s", strerror(__errno_location().*));
            break :blk 1;
        };
        if (gnl_ret == @as(c_int, 0)) break;
        curr.*.next = createLst(@ptrCast(@alignCast(line)), null);
        curr = curr.*.next;
    }
    if (!(curr != null)) return blk: {
        destructLst(head.next, free);
...
pub const __INTMAX_C_SUFFIX__ = @compileError("unable to translate macro: undefined identifier `L`"); // <builtin>:109:9
...
pub const __INT64_C_SUFFIX__ = @compileError("unable to translate macro: undefined identifier `L`"); // <builtin>:138:9
...
pub const __UINT32_FMTX__ = "X";
pub const __UINT32_C_SUFFIX__ = @compileError("unable to translate macro: undefined identifier `U`"); // <builtin>:163:9
...
pub const __UINT64_FMTX__ = "lX";
pub const __UINT64_C_SUFFIX__ = @compileError("unable to translate macro: undefined identifier `UL`"); // <builtin>:172:9
...
pub const offsetof = @compileError("unable to translate macro: undefined identifier `__builtin_offsetof`"); // /home/ubuntu/.downloads/zig-aarch64-linux-0.16.0/lib/compiler/aro/include/stddef.h:18:9
pub const __STDC_VERSION_STDARG_H__ = @as(c_int, 0);
pub const va_start = @compileError("unable to translate macro: undefined identifier `__builtin_va_start`"); // /home/ubuntu/.downloads/zig-aarch64-linux-0.16.0/lib/compiler/aro/include/stdarg.h:12:9
pub const va_end = @compileError("unable to translate macro: undefined identifier `__builtin_va_end`"); // /home/ubuntu/.downloads/zig-aarch64-linux-0.16.0/lib/compiler/aro/include/stdarg.h:14:9
pub const va_arg = @compileError("unable to translate macro: undefined identifier `__builtin_va_arg`"); // /home/ubuntu/.downloads/zig-aarch64-linux-0.16.0/lib/compiler/aro/include/stdarg.h:15:9
pub const __va_copy = @compileError("unable to translate macro: undefined identifier `__builtin_va_copy`"); // /home/ubuntu/.downloads/zig-aarch64-linux-0.16.0/lib/compiler/aro/include/stdarg.h:18:9
pub const va_copy = @compileError("unable to translate macro: undefined identifier `__builtin_va_copy`"); // /home/ubuntu/.downloads/zig-aarch64-linux-0.16.0/lib/compiler/aro/include/stdarg.h:22:9
...
pub const __f128 = @compileError("unable to translate macro: undefined identifier `f128`"); // /usr/include/aarch64-linux-gnu/bits/floatn.h:62:12
pub const __CFLOAT128 = @compileError("unable to translate: invalid numeric type"); // /usr/include/aarch64-linux-gnu/bits/floatn.h:71:12
...
pub const __f32 = @compileError("unable to translate macro: undefined identifier `f32`"); // /usr/include/aarch64-linux-gnu/bits/floatn-common.h:93:12
pub const __f64 = @compileError("unable to translate macro: undefined identifier `f64`"); // /usr/include/aarch64-linux-gnu/bits/floatn-common.h:105:12
pub const __f32x = @compileError("unable to translate macro: undefined identifier `f32x`"); // /usr/include/aarch64-linux-gnu/bits/floatn-common.h:113:12
pub const __f64x = @compileError("unable to translate macro: undefined identifier `f64x`"); // /usr/include/aarch64-linux-gnu/bits/floatn-common.h:125:12
pub const __CFLOAT32 = @compileError("unable to translate: invalid numeric type"); // /usr/include/aarch64-linux-gnu/bits/floatn-common.h:151:12
pub const __CFLOAT64 = @compileError("unable to translate: invalid numeric type"); // /usr/include/aarch64-linux-gnu/bits/floatn-common.h:163:12
pub const __CFLOAT32X = @compileError("unable to translate: invalid numeric type"); // /usr/include/aarch64-linux-gnu/bits/floatn-common.h:171:12
pub const __CFLOAT64X = @compileError("unable to translate: invalid numeric type"); // /usr/include/aarch64-linux-gnu/bits/floatn-common.h:183:12
...
pub const __O_NOFOLLOW = __helpers.promoteIntLiteral(c_int, 0o100000, .octal);
pub const __O_DIRECT = __helpers.promoteIntLiteral(c_int, 0o200000, .octal);
...
pub const LST_H = "";
pub const JUMP_KEYTYPE_SIZE = @as(c_int, 7);
...
pub const s_lst = struct_s_lst;
pub const s_info = struct_s_info;
